<nav class="sidebar">
    ...
    <a href="#" class="nav-item">
        <svg aria-label="Home" height="24" role="img" width="24" viewBox="0 0 24 24">
            <path d="M22 23h-6.001a1 1 0 0 1-1-1v-5.455a2.997 2.997 0 1 0-5.993 0V22a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V11.543a1.002 1.002 0 0 1 .31-.724l10-9.543a1.001 1.001 0 0 1 1.38 0l10 9.543a1.002 1.002 0 0 1 .31.724V22a1 1 0 0 1-1 1Z"></path>
        </svg>
        <span>Home</span>
    </a>
    <a href="#" class="nav-item">
        <svg aria-label="Search" height="24" role="img" width="24" viewBox="0 0 24 24">
    ...
    <a href="#" class="nav-item">
        <svg aria-label="Explore" height="24" role="img" width="24" viewBox="0 0 24 24">
    ...
    <a href="#" class="nav-item">
        <svg aria-label="Reels" height="24" role="img" width="24" viewBox="0 0 24 24">
    ...
    <a href="#" class="nav-item">
        <svg aria-label="Messages" height="24" role="img" width="24" viewBox="0 0 24 24">
    ...
    <a href="#" class="nav-item">
        <svg aria-label="Notifications" height="24" role="img" width="24" viewBox="0 0 24 24">
    ...
    <a href="#" class="nav-item">
        <svg aria-label="Create" height="24" role="img" width="24" viewBox="0 0 24 24">
    ...
    <a href="profile" class="nav-item">
        <img src="<?php echo url_for("\public\assets\images\profileImage\default-user.png"); ?>" alt="">
        <span>Profile</span>
    </a>


    <button class="more-button cursor-pointer" style="position: relative;">
    <div class="more-container">
            <div class="more-container">
                <svg aria-label="More" height="24" role="img" width="24" viewBox="0 0 24 24">
                ...
                <ul class="menu-bar">
                    <li class="menu_me_wrap">
                        <a href="<?php echo url_for('/settings'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-label="Settings" class="_ab6" color="#262626" fill="#262626" role="img" width="16" height="16" viewBox="0 0 24 24">
                    ...
                    <li class="menu_me_wrap">
                        <a href="<?php echo url_for('activity'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-label="activity" class="_ab6" color="#262626" fill="#262626" role="img" width="16" height="16" viewBox="0 0 24 24">
                                <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
                            </svg>
                            <span class="menu-text"> Your activity</span>
                        </a>
                    </li>
                    <li class="menu_me_wrap">
                        <a href="<?php echo url_for('saved'); ?>">
                            <svg aria-label="Saved" class="_ab6" color="#262626" fill="#262626" role="img" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12 15.1111L19.271 21.1702C19.5605 21.4115 20 21.2056 20 20.8288V2.22217H4V20.8288C4 21.2056 4.43949 21.4115 4.72897 21.1702L12 15.1111ZM6 17.5076L10.7196 13.5746C11.4613 12.9565 12.5387 12.9565 13.2804 13.5746L18 17.5076V4.22217H6V17.5076Z" fill="black" />
                            </svg>
                    ...
                    <li class="menu_me_wrap">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-label="switchappearance" class="_ab6" color="#262626" fill="#262626" role="img" width="16" height="16" viewBox="0 0 24 24">
                            ...
                            <span class="menu-text">Switch Appearance</span>
                        </a>
                    </li>

                    <li class="menu_me_wrap">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-label="report" class="_ab6" color="#262626" fill="#262626" role="img" width="16" height="16" viewBox="0 0 24 24">
                                <circle cx="12" cy="12" r="10"></circle>
                                <line x1="12" y1="8" x2="12" y2="12"></line>
                                <line x1="12" y1="16" x2="12.01" y2="16"></line>
                            </svg>
                            <span class="menu-text">Report a problem</span>
                        </a>
                    </li>

                    <li class="menu_me_wrap border-separator">
                        <a href="<?php echo url_for('switch_account'); ?>">
                            <span class="menu-text logout-text">Switch account</span>
                        </a>
                    </li>
